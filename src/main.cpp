...
unsigned int nStakeMinAge = 60 * 30;	// minimum age for coin age: 30min
unsigned int nStakeMaxAge = 60 * 60 * 24 * 90;	// stake age of full weight: 90d
unsigned int nStakeTargetSpacing = 10;			// 10 sec block spacing
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        nStakeTargetSpacing = 15; // test block spacing is 3 minutes
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0xff6f690d01b271025d8cff63ac24b574b82ec4713abae16f7c8121c8a296501a"));
