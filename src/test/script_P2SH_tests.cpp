...
BOOST_AUTO_TEST_CASE(norecurse)
{
    ...
    invalidAsScript << OP_INVALIDOCNODE << OP_INVALIDOCNODE;
    ...
    // Should not verify, because it will try to execute OP_INVALIDOCNODE
...
BOOST_AUTO_TEST_CASE(is)
{
    ...
    // Not considered pay-to-script-hash if using one of the OP_PUSHDATA ocnodes:
